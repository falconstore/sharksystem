// ArbiPro Calculator - Sistema de Arbitragem Completo
class ArbiProCalculator {
  constructor() {
    this.MAX_HOUSES = 6;
    this.numHouses = 2;
  ...
  addArbiProStyles() {
    if (document.getElementById('arbipro-styles')) return;
    
    const style = document.createElement('style');
    style.id = 'arbipro-styles';
    style.innerHTML = `
      .house-grid {
        display: grid;
...
// Export to window
window.ArbiProCalculator = ArbiProCalculator;